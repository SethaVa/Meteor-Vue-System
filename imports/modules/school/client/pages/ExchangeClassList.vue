...
//
import ExchangeClassInsert from './ExchangeClassInsert.vue'
import ExchangeClassUpdate from './ExchangeClassUpdate.vue'
...
import {
  findExchangeClass,
  removeExchangeClass,
} from '/imports/modules/school/api/exchange-class/methods.js'
export default {
  components: {
    ExchangeClassInsert,
    ExchangeClassUpdate,
