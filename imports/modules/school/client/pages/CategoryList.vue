<template>
  <div>
    ...
    <sub-category-form :form-type="formType"
                       :update-doc="updateDoc"
                       @data-change="getData">
    </sub-category-form>
    <!-- <time-form ></time-form> -->
...
import SubCategoryForm from './CategoryForm.vue'
import PositionUpdate from './PositionUpdate.vue'
import { findCategories, removeCategories } from '/imports/modules/school/api/categories/methods'
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      titles: [{ label: 'ID', prop: '_id' }, { label: 'Name', prop: 'name' }],
      tableProps: {
        size: 'mini',
      },
      actionColDef: {
