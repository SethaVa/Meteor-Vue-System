<template>
  <div>
    <el-dialog :close-on-click-modal="false" title="New Item In Stock"
               width="80%"
               :visible="visible"
      ...
      <el-form :model="form"
        ...
        <sub-item-form @save-form="saveForm"
                       :save-event="saveEvent"
                       :items-prop="itemsProp"
                       @sub-form-change="handleSubFormChange">
        </sub-item-form>
        <el-row :gutter="50">
          <el-col :span="16">
            &nbsp;
          ...
          <el-col :span="8">
            <div class="label-total">
              <label>Total Qty : {{ formatNum(totalQty) }} $</label><br><br>
...
//=============================================================
import { insertIncome } from '/imports/modules/school/api/Income/methods'
export default {
  // name: 'StockInsert',
