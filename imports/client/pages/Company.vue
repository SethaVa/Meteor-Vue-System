    ...
    <el-form v-loading="loading"
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          ...
          <el-form-item :rules="rules.address"
                        label="Address"
                        prop="address">
          ...
          <el-form-item :rules="rules.telephone"
                        label="Telephone"
                        prop="telephone">
        ...
        <el-col :span="12">
          <el-form-item :rules="rules.email"
                        label="Email"
                        prop="email">
            <el-input v-model="form.email"></el-input>
          </el-form-item>

          <el-form-item :rules="rules.website"
                        label="Website"
                        prop="website">
            <el-input v-model="form.website"></el-input>
          </el-form-item>

          <el-form-item :rules="rules.industry"
                        label="Industry"
                        prop="industry">
            <el-select v-model="form.industry"
                       placeholder="Industry"
                       style="width: 100%">
              <el-option v-for="item in industryOpts"
                         :key="item.value"
                         :label="item.label"
                         :value="item.value">
              </el-option>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :rules="rules.baseCurrency"
                        label="Base currency"
                        prop="setting.baseCurrency">
            <el-select v-model="form.setting.baseCurrency"
                       placeholder="Base currency"
                       style="width: 100%">
              <el-option v-for="item in currencyOpts"
                         :key="item.value"
                         :label="item.label"
                         :value="item.value">
              </el-option>
          ...
          <el-form-item :rules="rules.decimalNumber"
        ...
        <el-col :span="12">
          <el-form-item :rules="rules.dateFormat"
                        label="Date format"
                        prop="setting.dateFormat">
            <el-input v-model="form.setting.dateFormat"
                      readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :rules="rules.interface"
                        label="Form Interface"
                        prop="setting.interface">
            <!-- <el-switch v-model="form.setting.interface"></el-switch> -->
            <el-radio-group v-model="form.setting.interface">
        ...
        <el-col :span="12"
                :offset="12">
          <el-form-item :rules="rules.lang"
                        label="Language"
                        prop="setting.lang">
            <el-radio-group v-model="form.setting.lang">
              <el-radio v-for="item in langOpts"
                        :key="item.value"
